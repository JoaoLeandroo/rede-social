...
const MenuUser = () => {
  return (
    <div className="w-full md:w-auto fixed top-0 z-50 bg-slate-700/60">
      <nav className="md:hidden sticky top-0 flex shadow-lg w-full h-full p-2 items-center justify-between mx-auto">
      ...
      <aside className="hidden md:block min-h-screen border border-white/60 shadow-xl">
